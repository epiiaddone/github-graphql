...
// console.log('url path', process.env.REACT_APP_GITHUB_URL);
// console.log('pat path', process.env.REACT_APP_GITHUB_PAT);
...
function assertIsGetViewerResponse(
  response: any): asserts response is GetViewerResponse {
